        ...
        match self.gearType:
            case "One-Handed Weapon" | "Two-Handed Weapon":
                if self.tier:
                    ...
                    self.linkSuffix = "https://xeonrapture.com/xr/XRRPG+2.0/Sub-RPGs/Webrunning+2.0/Gear/Gear+Actives#"
            ...
            case "Kernel":
                ...
                self.isSingle = True
                self.linkSuffix = "https://xeonrapture.com/xr/XRRPG+2.0/Sub-RPGs/Webrunning+2.0/Gear/Kernels#"
            case "Consumable":
                self.abilityCatalog = abilityCatalog.ConsumableEffectCatalog(self.color, self.color2)
                self.isSingle = True
                self.linkSuffix = "https://xeonrapture.com/xr/XRRPG+2.0/Sub-RPGs/Webrunning+2.0/Gear/Consumables#"
            case "Bauble":
                self.abilityCatalog = abilityCatalog.BaubleEffectCatalog(self.color, self.color2)
                self.isSingle = True
                self.linkSuffix = "https://xeonrapture.com/xr/XRRPG+2.0/Sub-RPGs/Webrunning+2.0/Gear/Baubles#"
            case _:
